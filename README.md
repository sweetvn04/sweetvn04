...
<h3>🎮 PLAYER PROFILE // HUD STATUS 🎮</h3>

[![Player HUD](https://readme-typing-svg.demolab.com?font=Press+Start+2P&size=13&duration=3200&pause=1200&color=00FF66&background=0D1117&center=true&vCenter=true&width=800&height=130&lines=%3E+PLAYER%3A+sweetvn+(Nguyen+Quoc+Bao)+%7C+LV.21;%3E+GUILD%3A+CS+Senior+%40+Can+Tho+University+(CUSC);%3E+ROLE%3A+Backend+Intern+%40+CUSC+Software+Center;%3E+TARGET%3A+DevOps+%26+Platform+Engineer+(Go+%2F+K8s+%2F+IaC);%3E+STATUS%3A+HP+100%2F100+%E2%80%A2+MANA+85%2F100+%E2%80%A2+READY)](https://git.io/typing-svg)
...
<!-- ACTIVE QUESTS -->
<h3>⚔️ ACTIVE QUEST LOG // MISSIONS ⚔️</h3>

[![Quest Log](https://readme-typing-svg.demolab.com?font=Press+Start+2P&size=12&duration=3200&pause=1200&color=00F0FF&background=0D1117&center=true&vCenter=true&width=800&height=130&lines=%5B%E2%98%85+MAIN+QUEST%5D+G2B+Dynamic+Report+Designer+(Next.js+%2B+Drizzle);%5B%E2%9C%A6+SIDE+QUEST%5D+Hoshino+Zalo+AI+Companion+(sweetvn2004.id.vn);%5B%E2%9C%A6+SIDE+QUEST%5D+lazycat+Docker+Compose+TUI+Manager;%5B%E2%9A%94+HOMELAB%5D+Docker+%2B+Gitea+%2B+Ollama+%2B+Tailscale+%2B+CF+DDNS)](https://git.io/typing-svg)

<img src="https://capsule-render.vercel.app/api?type=rect&color=00F0FF&height=3" width="100%" alt="line"/>

<br>

<!-- EQUIPPED LOADOUT -->
<h3>🛡️ EQUIPPED LOADOUT & GEAR 🛡️</h3>

[![Equipped Gear](https://readme-typing-svg.demolab.com?font=Press+Start+2P&size=12&duration=3200&pause=1200&color=FFDF00&background=0D1117&center=true&vCenter=true&width=800&height=130&lines=%5BWEAPON%5D+Neovim+(LazyVim+Lua)+%2B+Fish+Shell+%2B+Kitty;%5BOS+CORE%5D+Arch+Linux+Scratch+Build+(Btrfs+%2B+Niri+Wayland);%5BRIG+SPEC%5D+ASUS+TUF+Gaming+F15+(i5-10300H+%2B+GTX+1650);%5BUPTIME%5D+100%25+Online+%E2%80%A2+16GB+RAM+%E2%80%A2+Kernel+Active)](https://git.io/typing-svg)

<img src="https://capsule-render.vercel.app/api?type=rect&color=FFDF00&height=3" width="100%" alt="line"/>
...
![My Skills](https://skillicons.dev/icons?i=linux,arch,bash,git,go,python,docker,kubernetes,neovim,ts,nextjs,mysql,nginx,githubactions,tailscale&perline=8)
